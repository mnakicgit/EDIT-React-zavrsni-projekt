					...
					<Container fluid className="bg-body-secondary rounded-4 mb-3 p-4">
						...
						<Row>
							<Col style={{ textAlign: "left" }}>
								<p>
									Ostale stranice nisam stigla dovršiti, ali ova je stranica potpuno funkcionalna na svim razinama. Pazila sam na detalje i potrudila se da ima sve elemente: ulogu admina, komunikaciju
									sa serverom, filtere, lijep raspored, responzivnost...
								</p>
								<p className="m-0">
								...
								{({ style }) => (
									<div className="mt-1 bg-body-secondary" style={{ ...style, zIndex: 1000, top: "4.5rem", paddingTop: "0.8rem", borderRadius: "1rem" }}>
										...
										<Form onSubmit={primjeniFiltere} className="p-2">
											<Form.Select className="mr-5" aria-label="Odabir grada iz padajuceg izbornika" name="grad" onChange={handleGradChange} value={filteri.grad}>
