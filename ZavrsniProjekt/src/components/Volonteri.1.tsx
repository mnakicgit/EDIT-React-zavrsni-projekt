	...
	return (
		<>
			...
			<Container className="p-0">
				...
				{kontekst && (
					<Container fluid className="bg-body-tertiary border-info rounded-4 p-4">
						<Row>
						...
						<Row>
							<div>
								...
								<Button variant={modifyButtons ? "info" : "primary"} onClick={prikaziPromijeni} className="mx-2">
									Promijeni
								</Button>

								<Button variant={deleteButtons ? "info" : "primary"} onClick={prikaziIzbrisi} className="mx-2">
									Izbriši
								</Button>
							</div>
						</Row>
				...
				<Row>
					...
					<Col className="col-sm-12 col-md-10 order-md-first mt-5">
						<KarticaVolontera volonteri={volonteriSaServera} prikaziIzbrisi={deleteButtons} prikaziPromijeni={modifyButtons} />
					</Col>
				</Row>
			</Container>
			...
			<Offcanvas show={showOffcanvas} onHide={handleClose} placement="end">
				<Offcanvas.Header closeButton>
					<Offcanvas.Title>Prijava</Offcanvas.Title>
				</Offcanvas.Header>
				<Offcanvas.Body>
